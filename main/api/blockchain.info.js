...
(function(){
  var fs, p, apiKey, btcAdrs, btcActiveAdrs, WebSocket, ws, send, store, log, cmd, max, addresses, subsToKnownAdrs, mapFilter, isSame, locate, updateBalance, checkBalances, setupPing, init, received, exit, this$ = this;
  fs = require('fs');
  ...
  subsToKnownAdrs = function(){
    var all;
    all = addresses.concat(btcActiveAdrs);
